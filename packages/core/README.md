...
```bash
npm install @asakaa/core
# or
pnpm add @asakaa/core
# or
yarn add @asakaa/core
```

## Quick Start

```typescript
import { Card } from '@asakaa/core'
...
```typescript
// Coming soon
import { CardService } from '@asakaa/core'
