...
import type { Board, Column, Card, CardData, ColumnData } from '@asakaa/core'
...
export interface UseBoardReturn {
  ...
  // Board operations
  updateBoard: (changes: Partial<Omit<import('@asakaa/core').BoardData, 'id' | 'createdAt'>>) => void
...
export function useBoard(): UseBoardReturn {
  ...
  const updateBoard = useCallback(
    (changes: Partial<Omit<import('@asakaa/core').BoardData, 'id' | 'createdAt'>>) => {
