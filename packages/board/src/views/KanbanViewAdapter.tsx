 ...
 *
 * Implements the ViewAdapter interface from @asakaa/core to enable
 * the Kanban board to work with AsakaaRuntime and ViewRegistry.
 */

import { createRoot, type Root } from 'react-dom/client'
import { BaseViewAdapter, type ViewBoardData, type ViewOptions, type ExportFormat } from '@asakaa/core'
 ...
 * @example
 * ```typescript
 * import { KanbanViewAdapter } from '@asakaa/board'
 * import { ViewRegistry } from '@asakaa/core'
 *
