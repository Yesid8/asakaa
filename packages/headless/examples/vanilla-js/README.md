...
This example demonstrates how to use `@asakaa/headless` with pure JavaScript without any framework.
...
```javascript
import { useBoardState, useCardDrag, useMultiSelect } from '@asakaa/headless'
...
app.js (Business logic)
    ↓
@asakaa/headless (Hooks)
    ↓
@asakaa/core (State management)
```
