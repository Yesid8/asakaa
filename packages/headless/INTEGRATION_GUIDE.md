# Integration Guide - @asakaa/headless
...
```typescript
import type { BoardData, CardData, ColumnData } from '@asakaa/core'
import type { UseBoardStateReturn } from '@asakaa/headless'
```
...
- Visit [@asakaa/board](../board) for pre-built React components
